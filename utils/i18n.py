...
TRANSLATIONS = {
    ...
    "Şifrə": "Password",
    "Daxil ol": "Sign in",
    "Demo accounts:\nadmin / demo123 · manager / demo123 · viewer / demo123": "Demo accounts:\nadmin / demo123 · manager / demo123 · viewer / demo123",
    "Xəta": "Error",
    "Məlumat": "Information",
    "Təsdiq": "Confirmation",
    ...
    "Təmir işləri": "Maintenance work",
    "Borc": "Debt-related suspension",
    "Qəza": "Emergency",
    "Yenidənqurma": "Reconstruction",
    "Müvəqqəti dayandırma": "Temporary suspension",
    "Yeni bağlantı": "New outage",
