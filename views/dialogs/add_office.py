"""
Yeni idarə əlavə etmə dialogu - Bağlantılar tabındakı kimi
"""
...
class AddOfficeDialog(QDialog):
    """Yeni idarə əlavə etmə dialogu"""

    def __init__(self, parent):
        super().__init__(parent)
        self.setWindowTitle("Yeni idarə")
        self.setModal(True)
    ...
    def _setup_ui(self):
        ...
        # Başlıq
        layout.addWidget(self._make_label("➕ Yeni idarə", "title"))
        layout.addWidget(self._make_label(
            "İdarə məlumatlarını doldurun", "muted"
        ))
